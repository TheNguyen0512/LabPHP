            ...
            <div class="row">
                ...
                <div class="lblinput">
                    <input type="number" name="math" value="<?php echo isset ($_POST['math']) ?
                        $_POST['math'] : ""; ?>" min="0" max="10" />
                    <?php
                    if (isset ($_SERVER["REQUEST_METHOD"]) && $_SERVER["REQUEST_METHOD"] == "POST" && ($_POST['math'] === "")) {
                        echo "<span class='error'>Please enter a valid math score</span>";
                    }
                    ?>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="lblinput">
                    <input type="number" name="chemistry" value="<?php echo isset ($_POST['chemistry']) ?
                        $_POST['chemistry'] : ""; ?>" min="0" max="10" />
                    <?php
                    if (isset ($_SERVER["REQUEST_METHOD"]) && $_SERVER["REQUEST_METHOD"] == "POST" && ($_POST['math'] === "")) {
                        echo "<span class='error'>Please enter a valid Chemistry score</span>";
                    }
                    ?>
